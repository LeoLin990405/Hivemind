 ...
 * - Sessions are linked to conversations in the main HiveMind database
 */
export class SessionManager {
   ...
   * Used when a conversation is deleted from HiveMind
   * 根据 conversationId 清理 session（当会话从 HiveMind 删除时调用）
   */
