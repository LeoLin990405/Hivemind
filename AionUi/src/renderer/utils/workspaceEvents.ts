export const WORKSPACE_TOGGLE_EVENT = 'hivemind-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'hivemind-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'hivemind-workspace-has-files';
