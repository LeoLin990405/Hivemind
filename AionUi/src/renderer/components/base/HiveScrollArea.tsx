 ...
 * <HiveScrollArea className="h-400px">
 *   <div>Content...</div>
 * </HiveScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <HiveScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </HiveScrollArea>
 *
 * // 双向滚动 / Both directions
 * <HiveScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </HiveScrollArea>
 * ```
 */
interface HiveScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const HiveScrollArea: React.FC<HiveScrollAreaProps> = ({ children, className, direction = 'y', disableOverflow = false, ...rest }) => {
...
HiveScrollArea.displayName = 'HiveScrollArea';

export default HiveScrollArea;
