...
export const ActivityTimeline: React.FC<ActivityTimelineProps> = ({ activities }) => {
  ...
  return (
    ...
    >
      <Typography variant='h6' bold style={{ marginBottom: '20px' }}>
        Recent Activity
      </Typography>
      <Timeline>
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                <Tag size='small' color={activity.type === 'task' ? 'purple' : activity.type === 'message' ? 'arcoblue' : 'green'} style={{ borderRadius: 'var(--radius-sm)' }}>
