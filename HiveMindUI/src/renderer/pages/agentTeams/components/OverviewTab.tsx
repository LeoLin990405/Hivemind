  ...
  return (
    <div className='hive-agent-tab-section'>
      <Description
        ...
        items={[
          ...
          },
          {
            ...
            value: <Badge variant='outline'>{team.task_allocation_strategy}</Badge>,
          },
          {
            label: (
              <Typography variant='caption' color='secondary'>
          ...
          },
          {
            ...
            value: `${stats?.total_tasks || 0} (done ${stats?.completed_tasks || 0}, failed ${stats?.failed_tasks || 0})`,
          },
          {
            label: (
              <Typography variant='caption' color='secondary'>
            ...
            value: `${stats?.avg_task_duration_ms || 0} ms`,
          },
        ]}
      />
      ...
      <div className='hive-agent-overview-actions'>
        ...
        <Button onClick={onQuickCreateTask}>Quick Add Task</Button>
      </div>
    </div>
  );
};
