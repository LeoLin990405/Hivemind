...
import { StatBadge, OverviewTab, TasksTab, MessagesTab, AnalyticsTab, TeamChatTab } from './components';
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className='px-5 pt-2'>
              ...
              <TabsTrigger value='chat'>
                <Typography variant='body2' bold={activeTab === 'chat'}>
                  Chat
                </Typography>
              </TabsTrigger>
            ...
            <TabsContent value='chat' className='p-0'>
              <TeamChatTab teamId={team.id} teammates={teammates} />
            </TabsContent>
