...
interface EventTypes {
  ...
  // 模型变更事件 / Model change events (header ↔ sendbox sync)
  'codex.model.changed': [string]; // modelId
  'openclaw.model.changed': [string]; // modelId
  'hivemind.model.changed': [{ provider: string; modelId: string }];
