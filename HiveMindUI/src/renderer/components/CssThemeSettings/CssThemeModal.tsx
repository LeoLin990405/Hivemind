...
const CssThemeModal: React.FC<CssThemeModalProps> = ({ visible, theme, onClose, onSave, onDelete }) => {
  ...
  return (
    <HiveModal visible={visible} header={isEditing ? t('settings.cssTheme.editTheme') : t('settings.cssTheme.addToPreset')} onCancel={onClose} footer={null} style={{ width: 600 }} unmountOnExit>
