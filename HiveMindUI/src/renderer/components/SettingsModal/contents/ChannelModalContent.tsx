...
const ChannelModalContent: React.FC = () => {
  ...
  const channels: ChannelConfig[] = useMemo(() => {
    const telegramChannel: ChannelConfig = {
      ...
      description: t('channels.telegramDesc', 'Chat with HiveMind assistant via Telegram'),
      status: 'active',
    ...
    const larkChannel: ChannelConfig = {
      ...
      description: t('channels.larkDesc', 'Chat with HiveMind assistant via Lark or Feishu'),
      status: 'active',
    ...
    const comingSoonChannels: ChannelConfig[] = [
      {
        ...
        description: t('channels.slackDesc', 'Chat with HiveMind assistant via Slack'),
        status: 'coming_soon',
        enabled: false,
        disabled: true,
      ...
      },
      {
        ...
        description: t('channels.discordDesc', 'Chat with HiveMind assistant via Discord'),
        status: 'coming_soon',
        enabled: false,
        disabled: true,
  ...
  return (
    <HiveScrollArea className={isPageMode ? 'h-full' : ''}>
