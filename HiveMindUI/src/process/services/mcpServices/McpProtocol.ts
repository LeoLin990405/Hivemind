...
let _electronApp: { getName: () => string; getVersion: () => string } | null = null;
try {
  // eslint-disable-next-line @typescript-eslint/no-var-requires
  _electronApp = require('electron').app;
  if (typeof _electronApp?.getName !== 'function') _electronApp = null;
} catch {
  _electronApp = null;
}
const app = _electronApp || { getName: () => 'HiveMind', getVersion: () => '1.11.1' };
