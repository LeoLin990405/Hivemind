...
export const STORAGE_KEYS = {
  ...
  WORKSPACE_TREE_COLLAPSE: 'hivemind_workspace_collapse_state',

  /** Workspace panel collapse state / 工作空间面板折叠状态 */
  WORKSPACE_PANEL_COLLAPSE: 'hivemind_workspace_panel_collapsed',

  /** Conversation tabs state / 会话 tabs 状态 */
  CONVERSATION_TABS: 'hivemind_conversation_tabs',

  /** Sidebar collapse state / 侧边栏折叠状态 */
  SIDEBAR_COLLAPSE: 'hivemind_sider_collapsed',

  /** Theme preference / 主题偏好 */
  THEME: 'hivemind_theme',

  /** Language preference / 语言偏好 */
  LANGUAGE: 'hivemind_language',
} as const;
