...
export const SECURITY_CONFIG = {
  HEADERS: {
    ...
    CSP_DEV:
      "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self'; connect-src 'self' ws: wss: blob: http://localhost:8765 http://127.0.0.1:8765 ws://localhost:8765 ws://127.0.0.1:8765 http://localhost:25808 ws://localhost:25808; media-src 'self' blob:;",
    // 生产环境 CSP（Content-Security-Policy for production）
    CSP_PROD:
      "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self'; connect-src 'self' ws: wss: blob: http://localhost:8765 http://127.0.0.1:8765 ws://localhost:8765 ws://127.0.0.1:8765 http://localhost:25808 ws://localhost:25808; media-src 'self' blob:;",
  },
  CSRF: {
